...
public class PermissionServiceImpl implements PermissionService {
    ...
    public List<MenuPerm> getMenuTree() {
        ...
        menuPermList.add(new MenuPerm(4,"pang","逄增瑶",1));
        menuPermList.add(new MenuPerm(5,"ssb","sb",4));

        menuPermList.add(new MenuPerm(6,"teacher","教师",1));
        menuPermList.add(new MenuPerm(7,"newreport","新建作业",6));
        menuPermList.add(new MenuPerm(8,"uploadreport","上传作业",6));
        menuPermList.add(new MenuPerm(9,"analysisreport","分析作业",6));

        menuPermList.add(new MenuPerm(10,"info","信息管理",1));
        menuPermList.add(new MenuPerm(11,"classinfo","班级管理",10));
        menuPermList.add(new MenuPerm(12,"stuinfo","学生管理",10));
        return menuPermList;
    }
